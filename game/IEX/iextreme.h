...
public:
	...
	void RenderI(s32 DstX, s32 DstY, s32 DstW, s32 DstH, s32 SrcX, s32 SrcY, s32 width, s32 height, float rad, u32 dwFlags = RS_COPY, COLOR color = 0xFFFFFFFF, float z = .0f);
};
...
public:
	...
	//------------------------------------------------------
	void Render();
	void Render( u32 dwFlags, float param=0 );
